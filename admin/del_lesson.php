  ...
  <body>
      <section class="container">
          ...
          <section class="row main">
              <div class="col-sm-9">
                   <h2 class="text-center">Удаление статьи</h2>
                <hr>
               
                <form class="text-center" name="del" method="POST" action="del_post.php">
              ...
              while( $myrow= mysqli_fetch_array($result));
                ...
                ?> 
              <input class="btn btn-default btn-success"type="submit" name="submit" id="submit" value="Удалить статью"></p></label><br>      
