      ...
      <section class="container">
          ...
          <section class="row main">
              <div class="col-sm-9">
                  ...
                  <h1 class="text-center">Редактирование категории</h1><br>
                  <hr>
                      <form action="edit_cat2.php" method="POST" name="form1" class="text-center">
                      <label><p>Название категории:<br>
                      <input type="text" name="title" id="title" value="<?php echo $myrow['title'];?>"></p></label><br>
                      <label><p>Описание категории:<br>
                      ...
                      <input class="btn btn-default btn-success"type="submit" name="submit" id="submit" value="Редактировать категорию"></p></label><br>
                  </form>
